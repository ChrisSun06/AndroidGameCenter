...
public class SlidingTile5x5ScoresFragment extends Fragment implements ScoresBoardFragmentInterface{
    /**
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Scores scores = new Scores("5X5sliding");
        View rootView = inflater.inflate(R.layout.fragment_sliding_tile5x5_scores, container, false);
